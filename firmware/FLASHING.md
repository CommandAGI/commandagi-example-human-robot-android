...
- An **ESP32-S3** or **ESP32-C3 / C6** dev board with native USB (e.g. _ESP32-S3-DevKitC-1_ or
  _Seeed XIAO ESP32C6_). Any board whose USB-UART bridge is CP210x / CH34x / FTDI also works.
...
1. Plug the ESP32 into the phone. **Settings → What am I driving? → Drone** shows it as _detected_.
